...
lsqlite3 and the upstream lsqlite3 binding are available under the MIT license. See `LICENSE` for the full text and pointers to SQLite's public-domain dedication.
